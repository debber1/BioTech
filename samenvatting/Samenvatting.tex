...
\begin{itemize}
	\item Rijst: basisvoedsel in vele ontwikkelingslanden
	\item Meest voorkomende problemen in verband met hongersnood te
	wijten aan vitamine A-tekort (bijv. blindheid, sterfte)
	\item Genetisch gemodificeerde rijst die grote hoeveelheden Pro-
	Vitamine A (=bètacaroteen) produceert (nodig: toevoeging van
	bacteriële en plantaardige genen)
\end{itemize}
