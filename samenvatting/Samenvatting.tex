...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{Diastereomeren}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{GlucoseAlphaBeta}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{Plasmamembraan}
