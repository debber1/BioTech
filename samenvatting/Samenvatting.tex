...
Cellulaire transportsystemen zijn systemen die het transport door de plasmamembraan regelen. Deze membraan is wel selectief doorlaatbaar, sommige stoffen passeren vrij, andere worden tegengehouden. We kunnen grosso modo drie verschillende manieren onderscheiden: passief, actief en bulk transport. 
...
\end{itemize}
Als men dit initieel mengt, vormt er een soort amorfe gel. Als deze substantie uit hard, krijgen we beton. Afhankelijk van de onderlinge percentuele aanwezigheid van de verschillende ingrediënten, krijgen we beton die specifiek voor een toepassing dient. 
...
Een biologisch proces om het zelf-herstel van beton mogelijk te maken is het `autonomoom' proces. Het lijkt sterk op de autonome aanpak uit de niet-biologische technieken, met als verschil dat de additieven dit maal van biologische aard zijn. \\
...
\begin{enumerate}
	...
	\item Opzuivering (Van de bekomen ethanol)
\end{enumerate}
